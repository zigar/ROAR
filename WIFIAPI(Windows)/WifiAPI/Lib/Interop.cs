...
namespace NativeWifi
{
    ...
    public static class Wlan
    {
        ...
        {
            public Dot11AuthAlgorithm dot11AuthAlgoId;
            public Dot11CipherAlgorithm dot11CipherAlgoId;
        }

        [StructLayout(LayoutKind.Sequential, CharSet = CharSet.Unicode)]
        public struct WlanAuthCipherPairList
        {
            public int numberofItems;

            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 32)]
            private Dot11AuthCipherPair[] authCipherPair;
            public Dot11AuthCipherPair[] AuthCipherPair
            {
                get
                {
                    Dot11AuthCipherPair[] ret = new Dot11AuthCipherPair[numberofItems];
                    Array.Copy(authCipherPair, ret, numberofItems);
                    return ret;
                }
            }
        }
